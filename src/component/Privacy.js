            ...
            <div className='container-fluid'>
                <div className='container d-flex'>
                    <div className='col-5 edit'>
                        <input type="text" id="form1Example2" placeholder='Current password **********' className="form-control shadow-none borber border-2 border-start-0 border-end-0 border-top-0 w-100" />
