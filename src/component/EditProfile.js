...
const Home = () => {
    ...
    return (
        <>
                ...
                <div className='col-1 Div-top'>
                    <ul className="">
                        <li className="ListRemove mx-3">
                            <NavLink onClick={() => setshow(true)} className="text-decoration-none mt-3">Edit</NavLink>
                        </li>
            ...
            {show ? 
                  <div className='container-fluid edit_cont'>
                  <div className='container d-flex edit-left'>
              ...
              :    
                ...
                <div className='container-fluid d-flex edit_2'>
